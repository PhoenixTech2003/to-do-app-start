...
export function HabitCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group relative flex items-center gap-3 p-4 bg-card border border-border rounded-md cursor-default transition-colors duration-200 hover:bg-accent border-l-[3px]',
        meta.border,
